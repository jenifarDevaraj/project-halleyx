...
return [
    ...
    */
    ...
    'driver' => 'ip-api', // or 'ipinfo', but must be defined below
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure as many location "drivers" as you like, and you
    | may even configure multiple drivers for the same location service.
    |
    */
    ...
    'drivers' => [
        ...
        'ipinfo' => [
            ...
            'token' => env('IPINFO_TOKEN', null), // optional token if you have one
        ],

        'ipstack' => [
            'class' => \Stevebauman\Location\Drivers\IpStack::class,
            'access_key' => env('IPSTACK_ACCESS_KEY', null),
            'secure' => false,
        ],
    ],
    /*
